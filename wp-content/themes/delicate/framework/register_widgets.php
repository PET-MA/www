<?php require_once(TEMPLATEPATH.'/framework/theme_widgets/twitter.php');
	  ...
	  require_once(TEMPLATEPATH.'/framework/theme_widgets/recent_posts.php');
	  require_once(TEMPLATEPATH.'/framework/theme_widgets/recent_pages.php');
	  require_once(TEMPLATEPATH.'/framework/theme_widgets/portfolio_widgets.php');
