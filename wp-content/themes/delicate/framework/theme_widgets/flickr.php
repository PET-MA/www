...
class MY_Flickr extends WP_Widget {
	...
	function MY_Flickr() {
		...
		$this->WP_Widget(false,IAMD_THEME_NAME.__(' Flickr Widget','dt_delicate'),$widget_options);
	}
	...
	function form($instance) {
        ...
        <p><label for="<?php echo $this->get_field_id('flickr_id'); ?>"><?php _e('Flickr ID:','dt_delicate');?>
        ...
        <p><label for="<?php echo $this->get_field_id('count'); ?>"><?php _e('How many entries do you want to show:','dt_delicate');?>
         ...
         <p><label for="<?php echo $this->get_field_id('show');?>"><?php _e('What pictures to display','dt_delicate'); ?>
         	<select class="widefat" id="<?php echo $this->get_field_id('show'); ?>" name="<?php echo $this->get_field_name('show'); ?>">
            <?php  $a = array("latest"=>__("Latest",'dt_delicate'),"random"=>__("Random",'dt_delicate'));
         ...
         <p><label for="<?php echo $this->get_field_id('size');?>"><?php _e('What pictures to display','dt_delicate'); ?>
         	<select class="widefat" id="<?php echo $this->get_field_id('size'); ?>" name="<?php echo $this->get_field_name('size'); ?>">
            <?php  $a = array("s"=>__("square",'dt_delicate'),"t"=>__("thumbnail",'dt_delicate'), "m" => __("medium",'dt_delicate'));
			foreach($a as $key => $value ):
