...
var mythemeAdmin = {
    ...
    jQuery("a.mytheme-import-button").bind('click',function(e){
      ...
      if(jQuery(this).hasClass('import-disabled')) {
        ...
        if(confirm(objectL10n.importConfirm)){
          ...
          var $dummy =  'delicate-default-dummy'; // replace this line with bellow line and enable the line no : 336
  ...
  backupOption: function(){
	  jQuery("a#mytheme_backup_button").click(function(e){
		  ...
		  if( ans ){
			 ...
			 var data =  { action : 'mytheme_backup_and_restore_action', type:'backup_options'};
			 jQuery('#ajax-feedback').css({display:'block'});
  ...
  restoreOption : function(){
	  jQuery("a#mytheme_restore_button").click(function(e){
		  ...
		  if( ans ){
			  var data =  { action : 'mytheme_backup_and_restore_action', type:'restore_options'};
			  //jQuery('#ajax-feedback').css({display:'block'});
  ...
  importOption : function() {
	  jQuery("a#mytheme_import_button").click(function(e){
		  ...
		  if( ans ){
			  var data =  { action : 'mytheme_backup_and_restore_action', type:'import_options', data : jQuery("#export_data").val()};
			  jQuery('#ajax-feedback').css({display:'block'});
