...
<div id="theme-footer" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel"> 
            <li><a href="#my-footer"><?php _e("Footer",'dt_delicate');?></a></li>
        </ul>
        ...
        <div id="my-footer" class="tab-content">
            ...
            <div class="bpanel-box">
                <div class="box-title">
                    <h3><?php _e('Footer','dt_delicate');?></h3>
                </div>
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                         ...
                         <h6><?php _e('Show Footer','dt_delicate');?></h6>
                        ...
                        <h6><?php _e('Footer Column Layout','dt_delicate');?></h6>
                        <p class="note"><?php _e("Select a perfect column layout style for your theme's footer.",'dt_delicate');?></p>
                    ...
                    <div class="bpanel-option-set">
                         <h6><?php _e('Show Copyright Text','dt_delicate');?></h6>
                        ...
                        <h6><?php _e('Copyright Text','dt_delicate');?></h6>
                        ...
                        <p class="note"> <?php _e('You can paste your copyright text in this box. This will be automatically added to the footer.','dt_delicate');?> </p>
                    </div><!-- .bpanel-option-set -->
