...
<div id="skin" class="bpanel-content">
    ...
    <div class="bpanel-main-content">
        <ul class="sub-panel">
			<?php $sub_menus = array(array("title"=>__("Skins",'dt_delicate'), "link"=>"#appearance-skins"));
        ...
        <div id="appearance-skins" class="tab-content">
	        <div class="bpanel-box">
                <div class="box-title"><h3><?php _e('Current Skin','dt_delicate');?></h3></div>
                ...
                <div class="box-title"><h3><?php _e('Available Skins','dt_delicate');?></h3></div>
                <div class="box-content">
