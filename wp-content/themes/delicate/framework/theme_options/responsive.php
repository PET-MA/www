...
<div id="mobile" class="bpanel-content">
  <!-- .bpanel-main-content -->
    <div class="bpanel-main-content">
        <ul class="sub-panel">
            <li><a href="#my-responsive"><?php _e("Responsive",'dt_delicate');?></a></li>        
        </ul>
        ...
        <div id="my-responsive" class="tab-content">
        	<div class="bpanel-box">
                ...
                <div class="box-title"><h3><?php _e('Responsive','dt_delicate');?></h3></div>
                <div class="box-content">
                
	                <div class="one-half-content">
    	            	<div class="bpanel-option-set">
                          <h6><?php _e("Make My Site Responsive",'dt_delicate');?></h6>
                          ...
                          <p class="note"><?php _e('Choose whether you need responsive version for your website','dt_delicate');?></p>
        	            </div>
                     </div>

	                <div class="one-half-content last">
    	            	<div class="bpanel-option-set">
	                      <h6><?php _e('Disable Slider for Mobile Devices','dt_delicate');?></h6>
                          ...
                          <p class="note"><?php _e('Choose whether you wish to hide / display the slider area of your website on mobile devices','dt_delicate');?></p>
        	            </div>
                    </div>
